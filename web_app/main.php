<?php
	...
	require_once 'includes/config.php';
     ...
     //    ev.preventDefault();
		...
		<center><h1 style="color:#3F51B5">Requests</h1>
		<?php

		//include 'includes/config.php';

		$expert_id = getuserid();
		$query="SELECT `id`,`notes`,`solution` from `requests` WHERE `is_spam`='0' AND `is_done`='0' AND `expert_id`='$expert_id'";
		...
		echo'<div class="col-md-12">
      	...
      	<br> 
      	<center><h1 style="color:#d2322d">Once an User will click a pic and sends it using Upaj App It will be available here.</h1></center>	
      	<br>
